...
type Data_Mongodb struct {
	...
	MinPoolSize string `protobuf:"bytes,5,opt,name=minPoolSize,proto3" json:"minPoolSize,omitempty"`
	MaxPoolSize string `protobuf:"bytes,6,opt,name=maxPoolSize,proto3" json:"maxPoolSize,omitempty"`
}
...
func (x *Data_Mongodb) GetMinPoolSize() string {
	if x != nil {
...
func (x *Data_Mongodb) GetMaxPoolSize() string {
	if x != nil {
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x69, 0x6e, 0x50, 0x6f, 0x6f, 0x6c, 0x53, 0x69,
	0x7a, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x6d, 0x61, 0x78, 0x50, 0x6f, 0x6f, 0x6c, 0x53, 0x69, 0x7a,
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x61, 0x78, 0x50, 0x6f, 0x6f, 0x6c,
	...
	0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x27, 0x5a, 0x25, 0x6e, 0x66,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Mongodb)(nil),        // 4: kratos.api.Data.Mongodb
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	4, // 3: kratos.api.Data.mongodb:type_name -> kratos.api.Data.Mongodb
